...
(async () => {
  ...
  assert.strictEqual(ctx.localStorage.getItem('stockAlertPendingUpdateVersion'), '8.04');
  assert.strictEqual(JSON.stringify(posted), JSON.stringify({ type: 'SKIP_WAITING', version: '8.04' }));
