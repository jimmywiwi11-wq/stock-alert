...
const APP_SHELL=['./','./index.html','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./app.js','./cash-reconciliation.js','./vendor/html2canvas.min.js','./modules/cms-integration/cms-integration.css','./modules/cms-integration/cms-product-adapter.js','./modules/cms-integration/cms-invoice-request-status.js','./modules/cms-integration/cms-integration.js'];
