...
assert.ok(parent.includes('V26-REQUEST-PRINT-QUEUE'));
assert.ok(parent.includes('ChokAnanCMSTaxInvoiceHistoryBridge.init'));
assert.ok(desktop.includes('V26-REQUEST-PRINT-QUEUE'));
...
assert.ok(desktop.includes('importEmployeeRequestToNative'));
