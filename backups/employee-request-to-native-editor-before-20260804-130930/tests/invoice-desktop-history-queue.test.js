...
assert.ok(desktop.includes('invoice-history-adapter.js?v=7.96'));
assert.ok(index.includes('cms-tax-invoice-history-bridge.js?v=7.96'));
assert.ok(index.includes('cms-integration.js?v=7.96'));
assert.ok(index.includes('invoice-generator.js?v=7.96'));
