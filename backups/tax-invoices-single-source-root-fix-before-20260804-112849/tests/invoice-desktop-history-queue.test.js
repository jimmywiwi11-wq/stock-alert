...
assert.ok(desktop.includes('Tax Invoice App V23'));
assert.ok(desktop.includes('invoice-history-adapter.js?v=7.91'));
assert.ok(index.includes('cms-integration.js?v=7.91'));
assert.ok(index.includes('invoice-generator.js?v=7.91'));
