...
(async () => {
  ...
  await page.fill('#cmsNewProductNameV42', 'UAT Existing Product A');
  ...
  await page.locator('.cmsInvoiceItemCompactV42').first().locator('input').nth(2).fill('pcs');
  await page.locator('.cmsInvoiceItemCompactV42').first().locator('input').nth(3).fill('125');
  await page.locator('.cmsInvoiceItemCompactV42').first().locator('input').nth(1).fill('3');
