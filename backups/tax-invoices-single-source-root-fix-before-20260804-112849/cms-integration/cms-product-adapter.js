(function(){
  ...
  function getStockAlertProducts(){
    if (window.ChokAnanProductMaster && typeof window.ChokAnanProductMaster.listActive === 'function') {
      return window.ChokAnanProductMaster.listActive().map(row => normalizeStockProduct(row, 'live-product-master')).filter(Boolean);
    }
