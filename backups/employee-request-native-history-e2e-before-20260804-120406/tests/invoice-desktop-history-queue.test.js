...
assert.ok(desktop.includes('Tax Invoice App V25'));
assert.ok(desktop.includes('invoice-history-adapter.js?v=7.93'));
assert.ok(index.includes('cms-tax-invoice-history-bridge.js?v=7.93'));
assert.ok(index.includes('cms-integration.js?v=7.93'));
assert.ok(index.includes('invoice-generator.js?v=7.93'));
