/* Stock Alert V7.57 - Cash Reconciliation */
(function(){
  const APP_VERSION='V7.57';
  ...
  function labels(){document.title='Stock Alert V7.57';const sub=document.getElementById('updateStatusSub');if(sub)sub.textContent=APP_VERSION;const b=document.querySelector('#updateModalVersionBox b');if(b)b.textContent=APP_VERSION;}
