/* Stock Alert V7.72 - Cash Reconciliation */
(function(){
  ...
  function ensureHomeButton(){
    ...
    const card=document.createElement('button');card.type='button';card.className=`cashHomeCardV749 ${theme}`;card.onclick=()=>openCashDeviceCurrent();
    ...
    const sales=document.createElement('button');sales.type='button';sales.className='cashHomeCardV749 salesHomeCardV768';sales.onclick=()=>openSalesMenu();
  ...
  function labels(){document.title='Stock Alert V7.72';const sub=document.getElementById('updateStatusSub');if(sub)sub.textContent=APP_VERSION;const b=document.querySelector('#updateModalVersionBox b');if(b)b.textContent=APP_VERSION;}
