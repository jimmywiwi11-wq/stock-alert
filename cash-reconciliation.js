/* Stock Alert V7.60 - Cash Reconciliation */
(function(){
  ...
  function ensureHomeButton(){
    ...
    const branch=Number(window.StockAlertDeviceBranch?.get?.()||1);
  ...
  function labels(){document.title='Stock Alert V7.60';const sub=document.getElementById('updateStatusSub');if(sub)sub.textContent=APP_VERSION;const b=document.querySelector('#updateModalVersionBox b');if(b)b.textContent=APP_VERSION;}
