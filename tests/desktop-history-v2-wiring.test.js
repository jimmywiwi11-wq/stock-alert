...
assert.ok(html.includes('native-invoice-repository.js?v=8.05'), 'desktop must load NativeInvoiceRepository');
assert.ok(html.includes('history-v2.js?v=8.05'), 'desktop must load History V2 renderer');
